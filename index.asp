...
<td>
  <table>
    ...
    <div class="main">
      <div class="item">
        <div style="color:yellow" onclick="toggleClose()">[View/Close Ad]</div>
        <script>
        var d = 1;
        function toggleClose() {
          if(d == 1) {
            document.getElementById("freeListing").style.display = "none";
            d = 2; 
          } else {
            document.getElementById("freeListing").style.display = "";
            d = 1;             
          }
        }
		setTimeout(toggleClose, 3300);

</script>
        <div id="freeListing">
          <img style="border:1px solid black" width="700" src="/graphics/free-listing.jpg"><br>
          <br>
        </div>
      	<%
